...
public class TestJsonRpcError {
  ...
  public void testBuilder_AllFields() {
    JsonRpcError<Integer> error =
        JsonRpcError.<Integer>builder().code(-32602).message("Invalid params").data(42).build();
  ...
  public void testBuilder_WithoutData() {
    JsonRpcError<?> error = JsonRpcError.builder().code(-32603).message("Internal error").build();
  ...
  public void testBuilder_WithNullData() {
    JsonRpcError<String> error =
        JsonRpcError.<String>builder().code(-32603).message("Internal error").data(null).build();
  ...
  public void testValidation_NullMessage() {
    JsonRpcException exception =
        assertThrows(JsonRpcException.class, () -> JsonRpcError.of(-32600, null));
  ...
  public void testValidation_EmptyMessage() {
    JsonRpcException exception =
        assertThrows(JsonRpcException.class, () -> JsonRpcError.of(-32600, ""));
    assertEquals(-32603, exception.getError().getCode());
  }
  ...
  public void testBuilder_MissingCode() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class, () -> JsonRpcError.builder().message("Test message").build());
  ...
  public void testBuilder_MissingMessage() {
    JsonRpcException exception =
        assertThrows(JsonRpcException.class, () -> JsonRpcError.builder().code(-32600).build());
    assertNotNull(exception.getError());
  }
  ...
  public void testError_LongMessage() {
    String longMessage =
        "This is a very long error message that contains a lot of text to test how the system handles lengthy descriptions";

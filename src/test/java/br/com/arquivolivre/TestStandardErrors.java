...
public class TestStandardErrors {
    ...
    public void testServerError_InvalidCode_TooLow() {
        JsonRpcException exception = assertThrows(JsonRpcException.class, 
            () -> StandardErrors.serverError(-32100, "Invalid"));
    ...
    public void testServerError_InvalidCode_TooHigh() {
        JsonRpcException exception = assertThrows(JsonRpcException.class, 
            () -> StandardErrors.serverError(-31999, "Invalid"));
        assertEquals(-32603, exception.getError().getCode());
    }
    ...
    public void testServerError_InvalidCode_Positive() {
        JsonRpcException exception = assertThrows(JsonRpcException.class, 
            () -> StandardErrors.serverError(100, "Invalid"));
        assertEquals(-32603, exception.getError().getCode());
    }
    ...
    public void testCannotInstantiate() {
        assertThrows(java.lang.reflect.InvocationTargetException.class, () -> {
            java.lang.reflect.Constructor<?> constructor = StandardErrors.class.getDeclaredConstructor();

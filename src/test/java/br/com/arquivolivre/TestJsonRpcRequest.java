...
public class TestJsonRpcRequest {
  ...
  public void testBuilder_AllFields() {
    JsonRpcRequest<String> request =
        JsonRpcRequest.<String>builder().method("subtract").params("test-params").id(1).build();
  ...
  public void testBuilder_WithoutParams() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("getStatus").id(1).build();
  ...
  public void testBuilder_WithoutId() {
    JsonRpcRequest<String> request =
        JsonRpcRequest.<String>builder().method("notify").params("notification-data").build();
  ...
  public void testBuilder_StringId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id("req-123").build();
  ...
  public void testBuilder_NumberId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id(42).build();
  ...
  public void testBuilder_ObjectId() {
    JsonRpcRequest<?> request =
        JsonRpcRequest.builder().method("test").id((Object) "obj-id").build();
  ...
  public void testBuilder_NullParams() {
    JsonRpcRequest<String> request =
        JsonRpcRequest.<String>builder().method("test").params(null).id(1).build();
  ...
  public void testNotification_WithComplexParams() {
    ...
    JsonRpcRequest<Map<String, Object>> notification =
        JsonRpcRequest.notification("notify", params);
  ...
  public void testValidation_NullMethod() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class, () -> JsonRpcRequest.builder().method(null).id(1).build());
  ...
  public void testValidation_EmptyMethod() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class, () -> JsonRpcRequest.builder().method("").id(1).build());
    assertNotNull(exception.getError());
  }
  ...
  public void testValidation_RpcPrefixMethod() {
    JsonRpcException exception =
        assertThrows(
            ...
            () -> JsonRpcRequest.builder().method("rpc.test").id(1).build());
    assertNotNull(exception.getError());
  ...
  public void testValidation_RpcDotPrefixMethod() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class,
            () -> JsonRpcRequest.builder().method("rpc.internal.method").id(1).build());
    assertNotNull(exception.getError());
  }
  ...
  public void testValidation_InvalidIdType() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class,
            () -> JsonRpcRequest.builder().method("test").id(new Object()).build());
    assertNotNull(exception.getError());
  ...
  public void testValidation_ArrayId() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class,
            () -> JsonRpcRequest.builder().method("test").id(new int[] {1, 2, 3}).build());
    assertNotNull(exception.getError());
  }
  ...
  public void testValidation_MapId() {
    JsonRpcException exception =
        assertThrows(
            JsonRpcException.class,
            () -> JsonRpcRequest.builder().method("test").id(new HashMap<>()).build());
    assertNotNull(exception.getError());
  }
  ...
  public void testValidation_NullIdExplicit() {
    ...
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id((String) null).build();
  ...
  public void testEdgeCase_ZeroId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id(0).build();
  ...
  public void testEdgeCase_NegativeId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id(-1).build();
  ...
  public void testEdgeCase_LargeNumberId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id(Long.MAX_VALUE).build();
  ...
  public void testEdgeCase_EmptyStringId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").id("").build();
  ...
  public void testEdgeCase_SpecialCharactersInMethod() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("user.login").id(1).build();
  ...
  public void testEdgeCase_UnderscoreInMethod() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("get_user_data").id(1).build();
  ...
  public void testEdgeCase_NumbersInMethod() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("method123").id(1).build();
  ...
  public void testEdgeCase_LongMethodName() {
    String longMethod =
        "thisIsAVeryLongMethodNameThatShouldStillBeValidAccordingToTheSpecification";
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method(longMethod).id(1).build();
  ...
  public void testIsNotification_WithoutId() {
    JsonRpcRequest<?> request = JsonRpcRequest.builder().method("test").build();
  ...
  public void testJsonrpcVersion_AlwaysTwoDotZero() {
    JsonRpcRequest<?> request1 = JsonRpcRequest.builder().method("test1").id(1).build();
  ...
  public void testParams_StringType() {
    JsonRpcRequest<String> request =
        JsonRpcRequest.<String>builder().method("test").params("string-param").id(1).build();
  ...
  public void testParams_IntegerType() {
    JsonRpcRequest<Integer> request =
        JsonRpcRequest.<Integer>builder().method("test").params(42).id(1).build();
  ...
  public void testParams_ListType() {
    ...
    JsonRpcRequest<java.util.List<Integer>> request =
  ...
  public void testParams_MapType() {
    ...
    JsonRpcRequest<Map<String, Object>> request =
        JsonRpcRequest.<Map<String, Object>>builder().method("test").params(params).id(1).build();

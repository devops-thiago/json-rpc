...
public class TestJsonRpcGson {
    ...
    public void testRequest_Deserialize_AllFields() {
        String json = "{\"jsonrpc\":\"2.0\",\"method\":\"subtract\",\"params\":{\"minuend\":42,\"subtrahend\":23},\"id\":1}";
    ...
    public void testRequest_Deserialize_InvalidMissingJsonrpc() {
        ...
        assertThrows(JsonRpcException.class, 
            () -> gson.fromJson(json, JsonRpcRequest.class));
    }
    ...
    public void testResponse_Deserialize_ErrorWithData() {
        String json = "{\"jsonrpc\":\"2.0\",\"error\":{\"code\":-32602,\"message\":\"Invalid params\",\"data\":\"Additional info\"},\"id\":1}";
    ...
    public void testResponse_Deserialize_InvalidBothResultAndError() {
        String json = "{\"jsonrpc\":\"2.0\",\"result\":19,\"error\":{\"code\":-32601,\"message\":\"Not found\"},\"id\":1}";
        
        assertThrows(JsonRpcException.class, 
            () -> gson.fromJson(json, JsonRpcResponse.class));
    }
    ...
    public void testError_Deserialize_InvalidMissingCode() {
        ...
        assertThrows(JsonRpcException.class, 
            () -> gson.fromJson(json, JsonRpcError.class));
    }

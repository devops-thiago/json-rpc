...
/**
 * Integration tests for complete JSON-RPC 2.0 request-response flows.
 * Tests protocol compliance, error handling, and end-to-end scenarios.
 */
public class IntegrationTest {
    ...
    public void testFlow_SuccessfulMethodCall() {
        ...
        JsonRpcRequest<Map<String, Integer>> request = JsonRpcRequest.<Map<String, Integer>>builder()
            .method("subtract")
            .params(params)
            .id(1)
            .build();
        ...
        int result = 19; // 42 - 23
        JsonRpcResponse<Integer> response = JsonRpcResponse.success(
            receivedRequest.getId().orElse(null), 
            result
        );
    ...
    public void testFlow_NotificationNoResponse() {
        ...
        JsonRpcRequest<String> notification = JsonRpcRequest.notification(
            "logMessage", 
            "Application started"
        );
    ...
    public void testFlow_MethodNotFoundError() {
        ...
        JsonRpcRequest<Object> request = JsonRpcRequest.builder()
        ...
        JsonRpcResponse<Object> response = JsonRpcResponse.error(
            receivedRequest.getId().orElse(null),
            error
        );
    ...
    public void testFlow_CustomServerError() {
        ...
        JsonRpcError<String> error = StandardErrors.serverError(
            -32001, 
    ...
    public void testErrorHandling_ParseError() {
        ...
        String malformedJson = "{\"jsonrpc\":\"2.0\",\"method\":\"test\",\"id\":1"; // missing closing brace
    ...
    public void testErrorHandling_ResponseWithBothResultAndError() {
        ...
        String invalidJson = "{\"jsonrpc\":\"2.0\",\"result\":42,\"error\":{\"code\":-32600,\"message\":\"Error\"},\"id\":1}";
    ...
    public void testRoundTrip_RequestWithStringParams() {
        JsonRpcRequest<String> original = JsonRpcRequest.<String>builder()
            .method("echo")
            .params("Hello, World!")
            .id("msg-1")
            .build();
    ...
    public void testRoundTrip_RequestWithMapParams() {
        ...
        JsonRpcRequest<Map<String, Object>> original = JsonRpcRequest.<Map<String, Object>>builder()
            .method("updateUser")
            .params(params)
            .id(100)
            .build();
    ...
    public void testRoundTrip_RequestWithArrayParams() {
        ...
        JsonRpcRequest<java.util.List<Integer>> original = JsonRpcRequest.<java.util.List<Integer>>builder()
            .method("sum")
            .params(params)
            .id(200)
            .build();
    ...
    public void testRoundTrip_RequestWithNullParams() {
        JsonRpcRequest<Object> original = JsonRpcRequest.builder()
            .method("ping")
            .params(null)
            .id(1)
            .build();
    ...
    public void testRoundTrip_ResponseWithNullResult() {
        ...
        // The result field should be present (either as null or omitted based on serialization)
    }
    ...
    public void testProtocolCompliance_RequestIdCanBeStringNumberOrNull() {
        // String id
        JsonRpcRequest<Object> req1 = JsonRpcRequest.builder()
            .method("test")
            .id("string-id")
            .build();
        ...
        // Number id
        JsonRpcRequest<Object> req2 = JsonRpcRequest.builder()
            .method("test")
            .id(123)
            .build();
    ...
    public void testComplexScenario_BatchProcessingSimulation() {
        ...
        requests[0] = JsonRpcRequest.builder()
            .method("add")
            .params(Map.of("a", 5, "b", 3))
            .id(1)
            .build();
        
        requests[1] = JsonRpcRequest.builder()
            .method("multiply")
            .params(Map.of("a", 4, "b", 7))
            .id(2)
            .build();
    ...
    public void testComplexScenario_ErrorRecovery() {
        ...
        JsonRpcResponse<Object> errorResponse = JsonRpcResponse.error(
            receivedRequest.getId().orElse(null),
            error
        );
        ...
        // Retry succeeds
        JsonRpcResponse<String> successResponse = JsonRpcResponse.success(
            receivedRequest.getId().orElse(null),
            "Success"
        );

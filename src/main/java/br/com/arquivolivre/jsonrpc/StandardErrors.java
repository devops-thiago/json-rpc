 ...
 *
 * <p>This class defines constants for all standard JSON-RPC 2.0 errors and provides convenient
 * factory methods for creating error objects. It also includes validation methods for reserved
 * error code ranges.
 *
 * <p>Standard error codes:
 *
 * <ul>
 *   <li>-32700: Parse error - Invalid JSON was received
 *   <li>-32600: Invalid Request - The JSON sent is not a valid Request object
 *   <li>-32601: Method not found - The method does not exist or is not available
 *   <li>-32602: Invalid params - Invalid method parameter(s)
 *   <li>-32603: Internal error - Internal JSON-RPC error
 * </ul>
 *
 * <p>Reserved error code ranges:
 *
 * <ul>
 *   <li>-32768 to -32000: Reserved for predefined errors
 *   <li>-32000 to -32099: Reserved for server-specific errors
 * </ul>
 */
public final class StandardErrors {
  ...
  // Error code ranges
  /** Minimum value for server-specific error codes. */
  public static final int SERVER_ERROR_MIN = -32099;

  /** Maximum value for server-specific error codes. */
  public static final int SERVER_ERROR_MAX = -32000;

  /** Minimum value for reserved error codes. */
  public static final int RESERVED_ERROR_MIN = -32768;

  /** Maximum value for reserved error codes. */
  ...
  /**
   * Creates a Parse Error (-32700). Invalid JSON was received by the server.
   *
  ...
  /**
   * Creates an Invalid Request error (-32600). The JSON sent is not a valid Request object.
   *
  ...
  /**
   * Creates a Method Not Found error (-32601). The method does not exist or is not available.
   *
  ...
  /**
   * Creates an Invalid Params error (-32602). Invalid method parameter(s).
   *
  ...
  /**
   * Creates an Internal Error (-32603). Internal JSON-RPC error.
   *
  ...
  /**
   * Creates a custom server error in the range -32000 to -32099. This range is reserved for
  ...
  public static JsonRpcError<?> serverError(int code, String message) {
    if (!isServerErrorCode(code)) {
      throw new JsonRpcException(
          JsonRpcError.of(
              INTERNAL_ERROR,
              "Server error code must be in range "
                  + SERVER_ERROR_MIN
                  + " to "
                  + SERVER_ERROR_MAX));
    }

 ...
 * 
 * <p>This class provides a pre-configured Gson instance with custom type adapters
 * for JsonRpcRequest, JsonRpcResponse, and JsonRpcError that properly handle:
 * <ul>
 *   <li>Generic params serialization in requests</li>
 *   <li>Result/error mutual exclusivity in responses</li>
 *   <li>Optional data field in errors</li>
 *   <li>Validation of all required fields during deserialization</li>
 * </ul>
 * 
 * <p>Example usage:
 * <pre>{@code
 ...
 *     .method("subtract")
 *     .params(Map.of("minuend", 42, "subtrahend", 23))
 *     .id(1)
 *     .build();
...
public final class JsonRpcGsonConfig {
     ...
     * <ul>
     *   <li>JsonRpcRequest - handles generic params and validation</li>
     *   <li>JsonRpcResponse - handles result/error mutual exclusivity</li>
     *   <li>JsonRpcError - handles optional data field</li>
     * </ul>
     * 
     * <p>All adapters perform validation during deserialization and throw
     * JsonRpcException for invalid JSON-RPC structures.
     * 

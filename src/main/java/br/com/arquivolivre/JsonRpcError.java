 ...
 * <ul>
 *   <li>code: An integer error code</li>
 *   <li>message: A concise string description (should be a single sentence)</li>
 *   <li>data: Optional additional error information</li>
 * </ul>
 * 

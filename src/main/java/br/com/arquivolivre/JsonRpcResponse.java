 ...
 * <ul>
 *   <li>jsonrpc: Always "2.0"</li>
 *   <li>id: The request id (can be null for parse errors)</li>
 *   <li>result: The result of a successful call (mutually exclusive with error)</li>
 *   <li>error: The error object for a failed call (mutually exclusive with result)</li>
 * </ul>
 * 
 * <p>This class enforces that exactly one of result or error is present.
 * Use the factory methods success() or error() to create instances.
 * 
...
public final class JsonRpcResponse<T> {
    ...
    /**
     * Private constructor that enforces mutual exclusivity of result and error.
     * Use factory methods success() or error() instead.
     */
